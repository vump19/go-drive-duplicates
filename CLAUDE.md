...
### 문서 저장소 규칙
- **모든 문서(계획, 기능, 디자인, 가이드, 히스토리)는 `../go-drive-duplicates-docs/`에 작성**
- 계획 문서 작성 시: `../go-drive-duplicates-docs/PLAN_*.md` 또는 `../go-drive-duplicates-docs/Plans/`
- 문서 작성/수정 후 **문서 저장소도 반드시 커밋 + 푸시** (메인 프로젝트와 별도로)
- 메인 프로젝트에는 문서 파일을 두지 않음
