...
// Permission represents a file/folder permission (sharing) entry
...
type StorageProvider interface {
	...
	ListFilesRecursive(ctx context.Context, folderID string, recursive bool) ([]*entities.File, error)
	...
	UploadFile(ctx context.Context, parentFolderID, fileName, mimeType string, content io.Reader) (string, error)
	DeleteFile(ctx context.Context, fileID string) error
	DeleteFiles(ctx context.Context, fileIDs []string) error
	TrashFile(ctx context.Context, fileID string) error
	TrashFiles(ctx context.Context, fileIDs []string) error
	...
	CreateFolder(ctx context.Context, parentID, folderName string) (string, error)
	...
	UploadCSVAsSpreadsheet(ctx context.Context, parentFolderID, fileName string, content io.Reader) (fileID string, webViewLink string, err error)
	...
	UpdatePermission(ctx context.Context, fileID string, permissionID string, newRole string) error
